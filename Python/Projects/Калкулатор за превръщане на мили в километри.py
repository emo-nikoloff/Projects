...
label = ttk.Label(
    master=window,
    text="Калкулатор за превръщане на мили в километри",
    font="Calibri 15 italic bold",
)
label.pack()
...
output_box = ttk.Entry(
    master=output_frame, font="Calibri 10", textvariable=output_string, state="readonly"
)
kilometers_label = ttk.Label(
    master=output_frame, text="Километри:", font="Calibri 10 bold"
)
